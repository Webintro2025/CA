...
export async function generateMetadata({ params }) {
    ...
    return {
        ...
        description: `Need Bookkeeping Accounting Services in ${cityName} Call Eazy Tax, Expert In GST Registration in ${cityName}, MSME Registration Services in ${cityName}, India.`,
        keywords: [
...
<div className="relative bg-gradient-to-r from-gray-800 via-blue-900 to-gray-800 w-full h-[220px] xs:h-[3=200px] sm:h-[300px] md:h-[380px] lg:h-[400px] xl:h-[400px]">
  ...
  <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-2 xs:px-4 sm:px-6 md:px-8 lg:px-10 xl:px-10">
    ...
    <p className="text-white font-medium text-[10px] xs:text-xs sm:text-sm md:text-base mt-2 sm:mt-4 max-w-xs xs:max-w-md sm:max-w-2xl md:max-w-3xl lg:max-w-4xl drop-shadow">
      Welcome To <a href="https://eazy-tax.in/">Eazy Tax</a>, If You Are Looking For <strong>Bookkeeping Accounting Services in {locationName}</strong>, We Are The Best Option For You. We Provide  <strong>Best GST Registration Services in {locationName}</strong>, Bookkeeping Accounting Services in {locationName}, Import Export Code (IEC) Registration Services in {locationName}, India.
    </p>
    <button
  ...
  <main className="w-full px-3 xs:px-4 sm:px-6 py-6 sm:py-8 md:py-10">
    <div className="flex flex-col md:flex-row gap-6 md:gap-10 items-center">
      ...
      <div className="w-full md:w-1/2 flex justify-center">
        <img
          alt={`Bookkeeping Accounting Services in ${locationName}`}
...
<div className="bg-white w-full px-16 xs:px-16 sm:px-16 py-6 sm:py-10 flex flex-col md:flex-row md:space-x-10 lg:space-x-20 ">
  <div className="w-full md:w-1/2 flex flex-col justify-center">
    <h2 className="text-lg xs:text-xl sm:text-2xl md:text-3xl leading-[1.2] mb-3 sm:mb-6 font-semibold">
      ...
      <span className="text-base xs:text-lg md:text-2xl font-normal block">Strong Financials, Stronger Decisions</span>
    </h2>
    <p className="text-xs xs:text-sm sm:text-base leading-relaxed max-w-xl">
      In today’s fast-paced and highly regulated business environment, maintaining accurate and up-to-date books of accounts is not optional—it is the foundation for sustainable growth. Our <strong>Bookkeeping Accounting Services in {locationName}</strong> ensure that businesses operate smoothly with real-time financial insights, error-free accounting, and complete statutory compliance.
      <br /><br />
      A professionally managed <a href="https://en.wikipedia.org/wiki/Bookkeeping">bookkeeping System</a> helps you track your finances with clarity, avoid tax penalties and legal risks, improve cash flow, strengthen decision-making, boost investor and lender confidence, and prepare for audits effortlessly.
      <br /><br />
      At <strong>Bookkeeping Accounting Services in {locationName}</strong> With our firm managing your accounts, you can focus entirely on scaling your business while we safeguard your financial backbone.
    </p>
  </div>
  ...
  <div className="flex flex-col md:flex-row gap-6 md:gap-10 border-t border-b border-gray-300 py-4 sm:py-6">
    <div className="w-full md:w-1/2 border-b md:border-b-0 md:border-r border-gray-300 pr-0 md:pr-6 pb-6 md:pb-0">
      <h2 className="text-base xs:text-lg sm:text-xl md:text-2xl text-center leading-[1.2] mb-4 sm:mb-8 font-semibold">
        Benefits of Outsourcing Bookkeeping Accounting Services in {locationName}
      </h2>
      <p className="text-xs xs:text-sm sm:text-base leading-relaxed">
        Outsourcing your accounting operations to a trusted CA firm like ours brings numerous advantages:
        <br /><br />
        ✔ <strong>Zero Errors and Total Accuracy</strong><br />
        Expert accountants ensure flawless books and eliminate the risks associated with in-house accounting mistakes.
        <br /><br />
        ✔ <strong>Saves Time and Operational Costs</strong><br />
        You avoid hiring, training, and managing an accounting team while saving up to 60% operational costs.
        <br /><br />
        ✔ <strong>Enhanced Focus on Core Business</strong><br />
        With financial responsibilities handled by experts, you can focus on expansion, branding, sales, and development.
      </p>
    </div>
    <div className="w-full md:w-1/2 pl-0 md:pl-6 mt-8 md:mt-0">
      <h2 className="text-base xs:text-lg sm:text-xl md:text-2xl text-center leading-[1.2] mb-4 sm:mb-8 font-semibold">
        More Reasons to Outsource Your Bookkeeping
      </h2>
      <p className="text-xs xs:text-sm sm:text-base leading-relaxed">
        ✔ <strong>Regular Reporting & Financial Insights</strong><br />
        We provide monthly and quarterly reports that help you take informed decisions backed by real-time financial data.
        <br /><br />
        ✔ <strong>Compliance Without Stress</strong><br />
        Never worry about missing deadlines, penalties, or non-compliance. We handle everything—from filings to documentation.
        <br /><br />
<strong>✔ Scalability & Flexibility</strong><br />
        As your business grows, our services adapt seamlessly to your evolving accounting needs.
        <br /><br />

        Eazy Tax <strong>Bookkeeping Accounting Services in {locationName}</strong> With our experienced team managing your books, you gain peace of mind and a strong financial foundation for long-term growth.
...
<div className="w-full mx-auto  py-6 sm:py-8 md:py-10">
  ...
  <p className="text-xs xs:text-sm sm:text-base mt-2 sm:mt-3 leading-[1.6]  px-4 mx-auto">
    We offer an extensive and fully integrated range of financial, compliance, and business registration services tailored to meet the diverse needs of startups, MSMEs, corporations, and growing enterprises across India. With over 30 years of expertise, our firm provides end-to-end support that ensures your business remains compliant, structured, and financially strong.
    From accurate <strong>Bookkeeping Accounting Services in {locationName}</strong> to seamless GST handling and from LLP registrations to securing your Import Export Code, our services are designed to simplify your operations, reduce risks, and empower your business with clarity and confidence.
  </p>
  <ul className="space-y-4 sm:space-y-6 text-xs xs:text-sm sm:text-base mt-4 sm:mt-6 leading-[1.6] list-none px-4 mx-auto">
    <li>
      <span className="font-bold">1. Bookkeeping Accounting Services in {locationName}</span><br />
      Our <strong>Bookkeeping Accounting Services in {locationName}</strong> form the backbone of your financial system. We handle everything from daily accounting entries to advanced financial statement preparation, including general ledger maintenance, payables and receivables tracking, reconciliations, monthly closures, and detailed financial reporting.
    </li>
    <li>
      <span className="font-bold">2. GST Registration Services in {locationName}</span><br />
      Our <strong>GST Registration Services in {locationName}</strong> simplify the entire GST onboarding process—from documentation and application filing to responding to departmental queries and guiding you on post-registration compliance so your business runs smoothly without penalties.
    </li>
    <li>
      <span className="font-bold">3. LLP Registration Services in {locationName}</span><br />
      Through our <strong>LLP Registration Services in {locationName}</strong>, we manage name reservation, DSC and DIN, incorporation filing, and LLP agreement drafting to ensure your Limited Liability Partnership is registered quickly, correctly, and in full compliance with MCA regulations.
    </li>
    <li>
      <span className="font-bold">4. MSME Registration Services in {locationName}</span><br />
      With our <strong>MSME Registration Services in {locationName}</strong>, we help you register on the Udyam portal so you can access government schemes, subsidies, priority lending, and other benefits designed specifically for micro, small, and medium enterprises.
    </li>
    <li>
      <span className="font-bold">5. Import Export Code (IEC) Registration Services in {locationName}</span><br />
      Our <strong>Import Export Code Registration Services in {locationName}</strong> cover the complete DGFT process—from application preparation and document verification to final IEC issuance—so you can confidently start or expand your import-export operations.
    </li>
  </ul>
...
<div className="w-full mx-auto px-16 xs:px-16 sm:px-16 py-6 sm:py-8 md:py-10">
  ...
  <p className="space-y-4 sm:space-y-6 text-xs xs:text-sm sm:text-base mt-2 sm:mt-3 leading-[1.6]">
    <strong>Decades of Experience, One Trusted Name:</strong> With 30+ years of distinguished expertise, we have built a reputation as one of the most dependable firms offering <strong>Bookkeeping Accounting Services in {locationName}</strong>. Our team consists of seasoned Chartered Accountants, tax experts, and compliance professionals.
    <br /><br />
    <strong>Highly Customized Solutions:</strong> Every business is unique. We analyze your workflow and offer tailor-made accounting solutions that simplify financial oversight and enhance organizational efficiency.
    <br /><br />
    <strong>Accuracy, Compliance & Transparency:</strong> We follow strict accounting protocols and ensure error-free books, 100% statutory compliance, and transparent processes so you always stay audit-ready.
    <br /><br />
    <strong>Latest Tools & Software:</strong> We use advanced and secure accounting software to deliver faster, more accurate, and highly reliable financial statements.
    <br /><br />
    <strong>End-to-End Financial Support Under One Roof:</strong> From bookkeeping to GST, business registrations, tax planning, ROC compliance, and advisory services everything you need is available with us.
    <br /><br />
    <strong>Cost-Effective & Scalable:</strong> Our services are affordable, especially for startups and MSMEs. As your business grows, we adapt and scale our services accordingly.
  </p>
</div>
